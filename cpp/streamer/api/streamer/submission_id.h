#ifndef NV_FILE_STREAMER_SUBMISSION_ID_H
#define NV_FILE_STREAMER_SUBMISSION_ID_H
...
typedef uint64_t NvFileStreamerSubmissionId;

#endif // NV_FILE_STREAMER_SUBMISSION_ID_H
